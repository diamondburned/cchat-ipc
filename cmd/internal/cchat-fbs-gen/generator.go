...
var customAttributes = []customAttribute{
	{"services", "services are names of RPC services that the table implements, if any."},
}
...
func (g *Generator) Finish() []byte {
	...
	output := bytes.Buffer{}
	output.Grow(1024 + g.header.Len() + g.body.Len())
	output.WriteString("// Code generated by ./cmd/internal. DO NOT EDIT.\n\n")
	...
	for _, path := range paths {
		...
		output.WriteString(strconv.Quote(path))
		output.WriteByte(';')
		output.WriteByte('\n')
	}
...
func (g *Generator) WriteHeaderLine() { g.header.WriteByte('\n') }
