...
func (rcv *UnreadIndicateReturns) Table() flatbuffers.Table {
	return rcv._tab
}

func (rcv *UnreadIndicateReturns) Call(obj *cchat__call.ID) *cchat__call.ID {
...
func (rcv *UnreadIndicateReturns) Err(obj *cchat__core.Error) *cchat__core.Error {
...
func (rcv *UnreadIndicateReturns) StopHandle(obj *cchat__call.StopHandle) *cchat__call.StopHandle {
