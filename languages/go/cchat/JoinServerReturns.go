...
func (rcv *JoinServerReturns) Err(obj *cchat__core.Error) *cchat__core.Error {
...
func (rcv *JoinServerReturns) StopHandle(obj *cchat__call.StopHandle) *cchat__call.StopHandle {
