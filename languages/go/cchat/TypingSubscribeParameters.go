...
func (rcv *TypingSubscribeParameters) Table() flatbuffers.Table {
	return rcv._tab
}

func (rcv *TypingSubscribeParameters) Call(obj *cchat__call.ID) *cchat__call.ID {
...
func TypingSubscribeParametersAddTypingContainer(builder *flatbuffers.Builder, typingContainer flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(typingContainer), 0)
}
