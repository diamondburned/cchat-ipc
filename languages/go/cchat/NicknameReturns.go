...
func (rcv *NicknameReturns) Err(obj *cchat__core.Error) *cchat__core.Error {
...
func (rcv *NicknameReturns) StopHandle(obj *cchat__call.StopHandle) *cchat__call.StopHandle {
