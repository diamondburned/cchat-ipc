...
type Instance struct {
	...
	// Asserted contains newly-asserted objects from the current object. It is a
	// slice of newly created objects from the result of this object's asserters
	// and can be directly referenced.
	Asserted []Instance `msg:"ass,omitempty"`

	// StopHandle is the handle ID to stop or destroy the object.
	StopHandle StopHandle `msg:"s,omitempty"`
}

// MethodID is the enumerated method identifiers.
type MethodID uint8
...
type Call struct {
	...
	// Method is the method ID to be called. It is not optional.
	Method MethodID `msg:"m"`
